...
\begin{exam}{\autoExamName}
  ...
  \begin{problem*}
    ...
    abbot, and reads the email thread, where he finds the bhikkhus commiserating
    about the abbot.

    \bigskip

    Do the following actions incur an offence? Mark \textbf{Yes} or \textbf{No}.

    \bigskip

      \begin{parts}

      \item \TF{N} He tells the abbot that some bhikkhus are forming a faction against him.
        
      \item \TF{N} He tells the bhikkhu not to criticize the abbot.

      \item \TF{N} He notices his own name, and opens that email thread, worried about being criticized.
