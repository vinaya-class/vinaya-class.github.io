\chapter{9.A. Kiccavatta}
\renewcommand*{\theChapterTitle}{9.A. Kiccavatta}
...
\begin{problem*}
  ...
  \item \TF{D/N} When you arrive at a monastery, wait to see the abbot until he tells you to see him.

  \begin{solution}
    Inquire what is the right time. Could be right there and then, could be the next day.
  \end{solution}
