...
\chapter{Lesson 1}
\label{sec:orgfbfe193}
\section{Language Notes}
\label{sec:org1a7333b}
...
\end{tabular}
\end{center}\footnotetext[2]{\label{orgc6ae7fb}Yathā vāri-vahā pūrā\ldots{}}
...
\section{Exercises}
\label{sec:org596d3e2}
\subsection{Translate}
\label{sec:orge393f41}
...
\end{tabular}
\end{center}\footnotetext[3]{\label{orga240746}\href{https://suttacentral.net/mn118/pli/ms}{MN 118}}

\normalArrayStrech

\subsection{Extra Challenge: Pāli Chat}
\label{sec:org6d4c97f}
\subsubsection{Greetings: Getting By}
\label{sec:org5b68559}
...
\chapter{Lesson 2}
\label{sec:orgdf9a2f3}
\section{Review Exercises}
\label{sec:org5d176e6}
...
\end{tabular}
\end{center}\footnotetext[4]{\label{orge8fcfcd}The only occurrence of vatth\textbf{ebhi}, normally it's vatth\textbf{ehi}.}
...
\section{Exercises}
\label{sec:org20b6f27}
\subsection{Translate}
\label{sec:orgc9dbc6b}
...
\end{tabular}
\end{center}\footnotetext[5]{\label{orge2f3677}\href{https://suttacentral.net/pli-tv-kd6/en/brahmali}{Mv. Kd 6}, Mahāvagga, The chapter on medicines (\emph{Bhesajjakkhandhaka})}
...
\subsection{Extra Challenge: Pāli Chat}
\label{sec:orgd8893b9}
\subsubsection{Phrases}
\label{sec:org3aef69f}
...
\chapter{Lesson 3}
\label{sec:org88e9b6d}
\section{Review Exercises}
\label{sec:orgb257c63}
...
\end{tabular}
\end{center}\footnotetext[6]{\label{orgbb2e09b}\href{https://suttacentral.net/an4.67/pli/ms}{AN 4.67}}\footnotetext[7]{\label{orgc8714cf}Paritta Ratanattaya-paṇāma, simpl.}\footnotetext[8]{\label{orgf24e9b4}\href{https://suttacentral.net/snp2.1/pli/ms}{Snp 2.1} simpl.}
...
\section{Exercises}
\label{sec:org0e0a26a}
\subsection{Translate}
\label{sec:org5e2424d}
...
\end{tabular}
\end{center}\footnotetext[10]{\label{org01360f3}Pc 65}\footnotetext[11]{\label{orgdc00767}\href{https://suttacentral.net/sn42.3/pli/ms}{SN 42.3}}\footnotetext[12]{\label{orgd1a4b0f}Pr 4, Pc 8}
...
\end{tabular}
\end{center}\footnotetext[13]{\label{orgc36a81a}Dukkhappattā\ldots{} chant}
...
\chapter{Appendix}
\label{sec:org2fb2ddf}
\section{Simple Present}
\label{sec:org722a11e}
...
\label{sec:orgf6161e5}
\subsection{Present Tense}
\label{sec:org2730071}
...
\label{sec:org7ba7a2e}
\subsection{Present Tense}
\label{sec:org65a7535}
...
\label{sec:org5a1107a}
\subsection{root + ta}
\label{sec:orgd173d25}
