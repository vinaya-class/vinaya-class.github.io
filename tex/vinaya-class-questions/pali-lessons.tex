...
\chapter{Lesson 1}
\label{sec:org8d236e9}
\section{Language Notes}
\label{sec:orga2cd914}
...
\end{tabular}
\end{center}\footnotetext[2]{\label{org2aaf368}Yathā vāri-vahā pūrā\ldots{}}
...
\section{Exercises}
\label{sec:org5ecb9d8}
\subsection{Cases Exercise: The Elephant}
\label{sec:org95adc5f}
...
\end{tabular}
\end{center}\footnotetext[3]{\label{org0597429}\href{https://suttacentral.net/mn118/pli/ms}{MN 118}}

\normalArrayStrech

\subsection{Extra Challenge: Pāli Chat}
\label{sec:orgd013114}
\subsubsection{Greetings: Getting By}
\label{sec:org0a7e18d}
...
\chapter{Lesson 2}
\label{sec:org7ae8ee9}
\section{Review Exercises}
\label{sec:org9b9a832}
...
\end{tabular}
\end{center}\footnotetext[4]{\label{org2213282}The only occurrence of vatth\textbf{ebhi}, normally it's vatth\textbf{ehi}.}
...
\section{Exercises}
\label{sec:org2195b94}
\subsection{Translate}
\label{sec:orga4b923d}
...
\end{tabular}
\end{center}\footnotetext[5]{\label{orgac5e539}\href{https://suttacentral.net/pli-tv-kd6/en/brahmali}{Mv. Kd 6}, Mahāvagga, The chapter on medicines (\emph{Bhesajjakkhandhaka})}
...
\subsection{Extra Challenge: Pāli Chat}
\label{sec:orgfd3b133}
\subsubsection{Phrases}
\label{sec:org4c20023}
...
\chapter{Lesson 3}
\label{sec:org3a3db20}
\section{Review Exercises}
\label{sec:org0815f9e}
...
\end{tabular}
\end{center}\footnotetext[6]{\label{org0320474}\href{https://suttacentral.net/an4.67/pli/ms}{AN 4.67}}\footnotetext[7]{\label{orgefc747a}Paritta Ratanattaya-paṇāma, simpl.}\footnotetext[8]{\label{org3c5243b}\href{https://suttacentral.net/snp2.1/pli/ms}{Snp 2.1} simpl.}
...
\section{Exercises}
\label{sec:orgbb6ed7c}
\subsection{Translate}
\label{sec:orge7d391c}
...
\end{tabular}
\end{center}\footnotetext[10]{\label{org88b53b4}Pc 65}\footnotetext[11]{\label{org7c4a0c3}\href{https://suttacentral.net/sn42.3/pli/ms}{SN 42.3}}\footnotetext[12]{\label{org63a8b72}Pr 4, Pc 8}
...
\end{tabular}
\end{center}\footnotetext[13]{\label{orgd8881dc}Dukkhappattā\ldots{} chant}
...
\chapter{Lesson 4}
\label{sec:orgd6a3987}
\section{Review Exercises}
\label{sec:org924fbda}
...
\section{Exercises}
\label{sec:orgdf70b72}
\chapter{Lesson 5}
\label{sec:orgd0f3773}
\section{Review Exercises}
\label{sec:org068f6d3}
...
\section{Exercises}
\label{sec:org9fbf35f}
\subsection{Translate}
\label{sec:org4dcbf2e}
...
\end{tabular}
\end{center}\footnotetext[15]{\label{orge0409cc}AN 6.102}
...
\chapter{Appendix}
\label{sec:org0116fbf}
\section{Simple Present}
\label{sec:org3f2aa8d}
...
\label{sec:orgd86f0ea}
\subsection{Present Tense}
\label{sec:org2cfb8f1}
...
\label{sec:org868f1d9}
\subsection{Present Tense}
\label{sec:org448ca90}
...
\label{sec:org23be7d9}
\subsection{root + ta}
\label{sec:orgf12b2ff}
