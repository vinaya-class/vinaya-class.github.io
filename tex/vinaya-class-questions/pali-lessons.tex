...
\chapter{Lesson 1}
\label{sec:orge53de76}
\section{Language Notes}
\label{sec:orge453ceb}
...
\end{tabular}
\end{center}\footnotetext[1]{\label{orgfd6d7b9}Yathā vāri-vahā pūrā\ldots{}}
...
\section{Exercises}
\label{sec:org94ba7e6}
\subsection{Translate}
\label{sec:org2c1335b}
...
\end{tabular}
\end{center}\footnotetext[2]{\label{orge76948a}\href{https://suttacentral.net/mn118/pli/ms}{MN 118}}

\normalArrayStrech

\subsection{Extra Challenge: Pāli Chat}
\label{sec:org3c4a298}
\subsubsection{Greetings: Getting By}
\label{sec:orgfda271d}
...
\chapter{Lesson 2}
\label{sec:org5a0d7fa}
\section{Review Exercises}
\label{sec:orge1438cb}
...
\end{tabular}
\end{center}\footnotetext[3]{\label{orgb897346}The only occurrence of vatth\textbf{ebhi}, normally it's vatth\textbf{ehi}.}
...
\section{Exercises}
\label{sec:org49a8551}
\subsection{Translate}
\label{sec:orga18f705}
...
\end{tabular}
\end{center}\footnotetext[4]{\label{orgc3899b2}\href{https://suttacentral.net/pli-tv-kd6/en/brahmali}{Mv. Kd 6}, Mahāvagga, The chapter on medicines (\emph{Bhesajjakkhandhaka})}
...
\chapter{Lesson 3}
\label{sec:org1f2af42}
\section{Review Exercises}
\label{sec:orgf039433}
...
\end{tabular}
\end{center}\footnotetext[5]{\label{org4ea7b47}\href{https://suttacentral.net/an4.67/pli/ms}{AN 4.67}}\footnotetext[6]{\label{org8c53b23}Paritta Ratanattaya-paṇāma, simpl.}\footnotetext[7]{\label{org3283398}\href{https://suttacentral.net/snp2.1/pli/ms}{Snp 2.1} simpl.}
...
\section{Exercises}
\label{sec:org6666fc3}
\subsection{Translate}
\label{sec:org327b9e6}
...
\end{tabular}
\end{center}\footnotetext[9]{\label{org34b5f7d}Pc 65}\footnotetext[10]{\label{orgedc848b}\href{https://suttacentral.net/sn42.3/pli/ms}{SN 42.3}}\footnotetext[11]{\label{org091672c}Pr 4, Pc 8}
...
\end{tabular}
\end{center}\footnotetext[12]{\label{orgbaf920b}Dukkhappattā\ldots{} chant}
...
\chapter{Lesson 4}
\label{sec:org234905b}
\section{Review Exercises}
\label{sec:orge899d73}
...
\section{Exercises}
\label{sec:org1b16eff}
\subsection{Translate}
\label{sec:org85a76b8}
...
\end{tabular}
\end{center}\footnotetext[14]{\label{org92baacf}AN 6.102}
...
\chapter{Lesson 5}
\label{sec:org4864ea4}
\section{Review Exercises}
\label{sec:org00b7945}
...
\section{Exercises}
\label{sec:org42ad17d}
\subsection{Translate}
\label{sec:orgcdf4977}
...
\end{tabular}
\end{center}\footnotetext[15]{\label{org523d634}MN 64, AN 9.36}
...
\chapter{Appendix}
\label{sec:org536dca2}
\section{Simple Present}
\label{sec:org861da54}
...
\label{sec:orgf305b14}
\section{Aorist Past Tense}
\label{sec:org53d639a}
...
\label{sec:org8f377ed}
\subsection{Present Tense}
\label{sec:org9a8bea5}
...
\label{sec:orgc06b0e2}
\subsection{Present Tense}
\label{sec:orgc858065}
...
\label{sec:orgfd80b60}
\subsection{root + ta}
\label{sec:org7c2c641}
