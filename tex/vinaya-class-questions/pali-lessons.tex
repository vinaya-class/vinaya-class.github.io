...
\chapter{Lesson 1}
\label{sec:org2f6b41d}
\section{Language Notes}
\label{sec:orgdfd5f82}
...
\end{tabular}
\end{center}\footnotetext[2]{\label{org11976e9}Yathā vāri-vahā pūrā\ldots{}}
...
\section{Exercises}
\label{sec:orgfdc2bdb}
\subsection{Translate}
\label{sec:org0e33321}
...
\end{tabular}
\end{center}\footnotetext[3]{\label{org2beccbd}\href{https://suttacentral.net/mn118/pli/ms}{MN 118}}

\normalArrayStrech

\subsection{Extra Challenge: Pāli Chat}
\label{sec:orgb941155}
\subsubsection{Greetings: Getting By}
\label{sec:org55b080a}
...
\chapter{Lesson 2}
\label{sec:org2e399dd}
\section{Review Exercises}
\label{sec:org4957273}
...
\end{tabular}
\end{center}\footnotetext[4]{\label{org78a1d57}The only occurrence of vatth\textbf{ebhi}, normally it's vatth\textbf{ehi}.}
...
\section{Exercises}
\label{sec:orgebbbc90}
\subsection{Translate}
\label{sec:orgb3f8e91}
...
\end{tabular}
\end{center}\footnotetext[5]{\label{org1859bf8}\href{https://suttacentral.net/pli-tv-kd6/en/brahmali}{Mv. Kd 6}, Mahāvagga, The chapter on medicines (\emph{Bhesajjakkhandhaka})}
...
\subsection{Extra Challenge: Pāli Chat}
\label{sec:org24b0a4c}
\subsubsection{Phrases}
\label{sec:orge2a9dd2}
...
\fillin{12cm}{Kattha āyasmato Vajiro bhikkhussa kaṭacchu hoti?}\\[0pt]
I don't know. Do you see it?\\[0pt]
\fillin{12cm}{Na jānāmi. Taṁ passasi?}\\[0pt]
This is his spoon. Give it to his attendant.\\[0pt]
\fillin{12cm}{Ayamassa kaṭacchu. Assaṁ / tassaṁ upaṭṭhākaṁ dehi.}\\[0pt]
I will wash your cup.\\[0pt]
\fillin{12cm}{Tuyhaṁ mallakaṁ dhovāmi / dhovissati.}\\[0pt]
(Please) Wash my bowl.\\[0pt]
\fillin{12cm}{Me pattaṁ dhova / dhovatha.}\\[0pt]
Where is your bowl?\\[0pt]
\fillin{12cm}{Kattha tuyhaṁ pattaṁ?}\\[0pt]
...
\fillin{12cm}{Dantaponaṁ me dehi.}\\[0pt]
...
\fillin{12cm}{Atthi me sayane bahu kipillikā.}\\[0pt]
\end{tabular}
\end{center}
...
\fillin{12cm}{Sace ācariyaṁ kāphīpānaṁ icchati, kāphīpānaṁ paṭiyādema.}\\[0pt]
...
\fillin{12cm}{Sace pānīyaṁ na hoti, pānīyaṁ upaṭṭhāpetabbaṁ.}\\[0pt]
If there's no rinsing water, rinsing water should be provided.\\[0pt]
\fillin{12cm}{Sace paribhojanīyaṁ na hoti, paribhojanīyaṁ upaṭṭhāpetabbaṁ.}\\[0pt]
\end{tabular}
\end{center}
...
Who is your friend or acquaintance here?\\[0pt]
\fillin{12cm}{Ko idha tava mitto vā sandiṭṭho vā?}\\[0pt]
The mayor of this city is a friend of mine.\\[0pt]
\fillin{12cm}{Idha nagaraguttiko mayhaṁ mitto hoti.}\\[0pt]
Where do you work?\\[0pt]
\fillin{12cm}{Kattha tvaṁ kammaṁ karosi?}\\[0pt]
I work in a post-office.\\[0pt]
\fillin{12cm}{Aham ekasmiṁ sandesāgāre kammaṁ karomi.}\\[0pt]
Where do you go from here?\\[0pt]
\fillin{12cm}{Ito tvaṁ kuhiṁ gacchasi?}\\[0pt]
I will go to another town from here.\\[0pt]
\fillin{12cm}{Aham ito aññaṁ nagaraṁ gamissāmi.}\\[0pt]
Do you like this place?\\[0pt]
\fillin{12cm}{Piyāyasi tvam idaṁ ṭhānaṁ?}\\[0pt]
I may like this if it is not too hot.\\[0pt]
...
I will go home when I get enough money.\\[0pt]
\fillin{12cm}{Yadā pahoṇakaṁ mūlaṁ labhissāmi, tadā'haṁ gamissāmi.}\\[0pt]
How much money have you now with you?\\[0pt]
\fillin{12cm}{Kittakaṁ mūlaṁ 'dāni tava santike atthi?}\\[0pt]
I have fourteen rupees and fifty cents.\\[0pt]
\fillin{12cm}{Cuddasa rūpiyāni aḍḍharūpiyañ ca mama santike santi.}\\[0pt]
\end{longtable}
...
\chapter{Lesson 3}
\label{sec:org53c83e2}
\section{Review Exercises}
\label{sec:org084cbf1}
...
\end{tabular}
\end{center}\footnotetext[6]{\label{orgf1a8f92}\href{https://suttacentral.net/an4.67/pli/ms}{AN 4.67}}\footnotetext[7]{\label{org1e80a57}Paritta Ratanattaya-paṇāma, simpl.}\footnotetext[8]{\label{orgd9531c3}\href{https://suttacentral.net/snp2.1/pli/ms}{Snp 2.1} simpl.}
...
\section{Exercises}
\label{sec:orgcaf2571}
\subsection{Translate}
\label{sec:orgc0157dd}
...
\end{tabular}
\end{center}\footnotetext[10]{\label{orgbdc221d}Pc 65}\footnotetext[11]{\label{org60545ef}\href{https://suttacentral.net/sn42.3/pli/ms}{SN 42.3}}\footnotetext[12]{\label{org9d64e54}Pr 4, Pc 8}
...
\end{tabular}
\end{center}\footnotetext[13]{\label{org741d72b}Dukkhappattā\ldots{} chant}
...
\chapter{Lesson 4}
\label{sec:orgd22c0ce}
\section{Review Exercises}
\label{sec:orga13e076}
...
\section{Exercises}
\label{sec:orga7379c8}
\subsection{Translate}
\label{sec:orgbb34a03}
...
\end{tabular}
\end{center}\footnotetext[15]{\label{orgf1509e3}AN 6.102}
...
\chapter{Lesson 5}
\label{sec:org02b7fd1}
\section{Review Exercises}
\label{sec:orgc84c62a}
...
\section{Exercises}
\label{sec:orgd13f837}
\subsection{Translate}
\label{sec:orgedbe0e0}
...
\end{tabular}
\end{center}\footnotetext[16]{\label{org105c1fc}MN 64, AN 9.36}
...
\chapter{Appendix}
\label{sec:org40b2fed}
\section{Simple Present}
\label{sec:org406e399}
...
\label{sec:orgff5e0b6}
\subsection{Present Tense}
\label{sec:org6b38e55}
...
\label{sec:org00a9c35}
\subsection{Present Tense}
\label{sec:org8ad47de}
...
\label{sec:org71d0cc1}
\subsection{root + ta}
\label{sec:orge27dc85}
