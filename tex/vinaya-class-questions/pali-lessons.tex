...
\chapter{Lesson 1}
\label{sec:org81e3bfa}
\section{Language Notes}
\label{sec:org003bb4c}
...
\end{tabular}
\end{center}\footnotetext[2]{\label{orga46a1fd}Yathā vāri-vahā pūrā\ldots{}}
...
\section{Exercises}
\label{sec:orgc3c4686}
\subsection{Translate}
\label{sec:orgf424cf5}
...
\end{tabular}
\end{center}\footnotetext[3]{\label{org2f4b925}\href{https://suttacentral.net/mn118/pli/ms}{MN 118}}

\normalArrayStrech

\subsection{Extra Challenge: Pāli Chat}
\label{sec:org633d8ca}
\subsubsection{Greetings: Getting By}
\label{sec:org1feacf8}
...
\chapter{Lesson 2}
\label{sec:org0bedf2b}
\section{Review Exercises}
\label{sec:org58ea7ad}
...
\end{tabular}
\end{center}\footnotetext[4]{\label{orgc779166}The only occurrence of vatth\textbf{ebhi}, normally it's vatth\textbf{ehi}.}
...
\section{Exercises}
\label{sec:orga2b14ac}
\subsection{Translate}
\label{sec:orgab37dbf}
...
\end{tabular}
\end{center}\footnotetext[5]{\label{org466693e}\href{https://suttacentral.net/pli-tv-kd6/en/brahmali}{Mv. Kd 6}, Mahāvagga, The chapter on medicines (\emph{Bhesajjakkhandhaka})}
...
\subsection{Extra Challenge: Pāli Chat}
\label{sec:orgc7d9862}
\subsubsection{Phrases}
\label{sec:org25fa1ae}
...
\chapter{Lesson 3}
\label{sec:orga4bb107}
\section{Review Exercises}
\label{sec:orgcc94d2a}
...
\end{tabular}
\end{center}\footnotetext[6]{\label{orgc437c64}\href{https://suttacentral.net/an4.67/pli/ms}{AN 4.67}}\footnotetext[7]{\label{org9a581f5}Paritta Ratanattaya-paṇāma, simpl.}\footnotetext[8]{\label{orge348e9b}\href{https://suttacentral.net/snp2.1/pli/ms}{Snp 2.1} simpl.}
...
\section{Exercises}
\label{sec:orgd6f5bff}
\subsection{Translate}
\label{sec:org7671758}
...
\end{tabular}
\end{center}\footnotetext[10]{\label{org41890e3}Pc 65}\footnotetext[11]{\label{org2c27744}\href{https://suttacentral.net/sn42.3/pli/ms}{SN 42.3}}\footnotetext[12]{\label{orge623318}Pr 4, Pc 8}
...
\end{tabular}
\end{center}\footnotetext[13]{\label{orged09c71}Dukkhappattā\ldots{} chant}
...
\chapter{Appendix}
\label{sec:org2dfe25d}
\section{Simple Present}
\label{sec:org7e12f1a}
...
\label{sec:org43447e0}
\subsection{Present Tense}
\label{sec:orgd6cb381}
...
\label{sec:org9a969ff}
\subsection{Present Tense}
\label{sec:org50806bb}
...
\label{sec:org7d8f6fd}
\subsection{root + ta}
\label{sec:orgc11e72c}
