...
\chapter{Lesson 1}
\label{sec:orga687ed6}
\section{Language Notes}
\label{sec:org9d3b840}
...
\end{tabular}
\end{center}\footnotetext[2]{\label{org1da9dfe}Yathā vāri-vahā pūrā\ldots{}}
...
\section{Exercises}
\label{sec:org61e51a3}
\subsection{Translate}
\label{sec:org2464f16}
...
\end{tabular}
\end{center}\footnotetext[3]{\label{orgf5dd46c}\href{https://suttacentral.net/mn118/pli/ms}{MN 118}}

\normalArrayStrech

\subsection{Extra Challenge: Pāli Chat}
\label{sec:orgc1995b7}
\subsubsection{Greetings: Getting By}
\label{sec:orgce61c3d}
...
\chapter{Lesson 2}
\label{sec:org1e98b7f}
\section{Review Exercises}
\label{sec:org113c2a7}
...
\end{tabular}
\end{center}\footnotetext[4]{\label{org51d1475}The only occurrence of vatth\textbf{ebhi}, normally it's vatth\textbf{ehi}.}
...
\section{Exercises}
\label{sec:org05dcee6}
\subsection{Translate}
\label{sec:org0243e06}
...
\end{tabular}
\end{center}\footnotetext[5]{\label{org019e617}\href{https://suttacentral.net/pli-tv-kd6/en/brahmali}{Mv. Kd 6}, Mahāvagga, The chapter on medicines (\emph{Bhesajjakkhandhaka})}
...
\subsection{Extra Challenge: Pāli Chat}
\label{sec:org7cf737f}
\subsubsection{Phrases}
\label{sec:org5a0fcb0}
...
\chapter{Lesson 3}
\label{sec:orgd9048ca}
\section{Review Exercises}
\label{sec:orgc863c61}
...
\end{tabular}
\end{center}\footnotetext[6]{\label{org5c67a95}\href{https://suttacentral.net/an4.67/pli/ms}{AN 4.67}}\footnotetext[7]{\label{org393878c}Paritta Ratanattaya-paṇāma, simpl.}\footnotetext[8]{\label{org436add2}\href{https://suttacentral.net/snp2.1/pli/ms}{Snp 2.1} simpl.}
...
\section{Exercises}
\label{sec:org2ac1714}
\subsection{Translate}
\label{sec:org9c80785}
...
\end{tabular}
\end{center}\footnotetext[10]{\label{org59b4298}Pc 65}\footnotetext[11]{\label{org2a65320}\href{https://suttacentral.net/sn42.3/pli/ms}{SN 42.3}}\footnotetext[12]{\label{org52eb005}Pr 4, Pc 8}
...
\end{tabular}
\end{center}\footnotetext[13]{\label{org61d9658}Dukkhappattā\ldots{} chant}
...
\chapter{Appendix}
\label{sec:org4a4203d}
\section{Simple Present}
\label{sec:org984ca89}
...
\label{sec:org9c25b59}
\subsection{Present Tense}
\label{sec:org4f6cd7d}
...
\label{sec:org76c7d58}
\subsection{Present Tense}
\label{sec:orgdefa24c}
...
\label{sec:org71d45a8}
\subsection{root + ta}
\label{sec:org8650c5c}
...
\url{https://vinaya-class.github.io/00-pali-lessons.html}
