...
\chapter{Lesson 1}
\label{sec:org4a07fe8}
\section{Language Notes}
\label{sec:orgfdf95cd}
...
\end{tabular}
\end{center}\footnotetext[1]{\label{org69185ff}Yathā vāri-vahā pūrā\ldots{}}
...
\section{Exercises}
\label{sec:orge118678}
\subsection{Translate}
\label{sec:org135ffc0}
...
\end{tabular}
\end{center}\footnotetext[2]{\label{org5c7e8f2}\href{https://suttacentral.net/mn118/pli/ms}{MN 118}}
...
\begin{center}
\begin{tabular}{ll}
Good morning Ven. Sir! & Supubbaṇho bhante.\\[0pt]
...
good morning & supubbaṇha\\[0pt]
 & [su + pubba + aṇha]\\[0pt]
 & pubbaṇhasamayaṁ\\[0pt]
good midday & sumajjhanhika\\[0pt]
 & [su + majjha + anha + ika]\\[0pt]
...
\begin{center}
\begin{tabular}{ll}
feels; experiences & vedayati\\[0pt]
...
\begin{itemize}
\item \href{https://suttacentral.net/an3.155/en/sujato}{AN 3.155, Morning}
\item \href{https://suttacentral.net/pli-tv-kd8/en/brahmali}{Kd 8, Sec. 18: The account of Visākhā}
\end{itemize}

\clearpage

\subsubsection{Conversation 1}
\label{sec:org7ed2375}
...
\fillin{12cm}{Supubbaṇho āvuso. Kacci te khamanīyaṁ?}\\[0pt]
\textbf{[B]} I am not well, Sir. I feel cold.\\[0pt]
\fillin{12cm}{Na me, bhante, khamanīyaṁ. Sītaṁ vedayāmi.}\\[0pt]
\textbf{[A]} Tomorrow will be hot. Do you want a hot drink?\\[0pt]
\fillin{12cm}{Suve uṇhaṁ bhavissati. Pānaṁ uṇhaṁ icchasi?}\\[0pt]
\textbf{[B]} A cup with hot water is a good idea (agreeable thought).\\[0pt]
\fillin{12cm}{Mallako uṇhodakassa vitakkaṁ piyarūpaṁ.}\\[0pt]
\textbf{[A]} Right here friend. Do you come from the country Spain?\\[0pt]
\fillin{12cm}{Etthevaṁ āvuso. Spain janapadasmā āgacchasi?}\\[0pt]
...
\fillin{12cm}{Katthañca vasatha bhante?}\\[0pt]
\textbf{[A]} I live in Norway. There it is always cold.\\[0pt]
\fillin{12cm}{Norway janapade vasāmi. Tatra sītaṁ sabbadā.}\\[0pt]
\textbf{[A]} I must go now. (See you) next week.\\[0pt]
\fillin{12cm}{Handa dāni ahaṁ gacchāmi. Parasatta.}\\[0pt]
...
\fillin{12cm}{Svāgataṁ bhante. Ayyo idha āgacchatu. Kaccisi appakilamathena?}\\[0pt]
...
\fillin{12cm}{Taṁ kissa hetu? Na ajj'āccuṇhaṃ.}\\[0pt]
\textbf{[B]} Having walked for alms, having received a lot of food, my bowl is heavy.\\[0pt]
\fillin{12cm}{Piṇḍāya caritvā, bahu khādanīyaṁ paṭiggahetvā, pattaṁ me garuṁ.}\\[0pt]
\textbf{[A]} Please sit here. Where does the master go for alms?\\[0pt]
\fillin{12cm}{Idha nisīdatha. Kuhiṁ piṇḍāya ayyo gacchati?}\\[0pt]
\textbf{[B]} In the town called Ericeira, there is the market. I go there for alms.\\[0pt]
\fillin{12cm}{Gāme Ericeira nāmo, atthi antarāpaṇo. Tatra piṇḍāya gacchāmi.}\\[0pt]
...
\fillin{12cm}{Pattaṁ me gahetvā, piṇḍaṁ bhikkhūhi saddhiṁ saṁvibhajitabbaṁ.}\\[0pt]
\textbf{[A]} Please say if, Sir, (you are with) a want for water.\\[0pt]
\fillin{12cm}{Bhāseyya, sace te bhante, udakena attho.}\\[0pt]
\textbf{[B]} A cup with cold water will be refreshing (healthy).\\[0pt]
\fillin{12cm}{Mallako sītodakassa kallakassa (kallakāya) bhavissati.}\\[0pt]
\textbf{[A]} Wait here Sir, I will bring it to you.\\[0pt]
\fillin{12cm}{Ettheva tiṭṭha bhante, ettheva te āharissāmi.}\\[0pt]
\end{tabular}
\end{center}
...
\chapter{Lesson 2}
\label{sec:org1e1f268}
\section{Review Exercises}
\label{sec:org87df046}
...
\end{tabular}
\end{center}\footnotetext[3]{\label{org7677600}The only occurrence of vatth\textbf{ebhi}, normally it's vatth\textbf{ehi}.}
...
\section{Exercises}
\label{sec:org8b9c866}
\subsection{Translate}
\label{sec:org872a72b}
...
\chapter{Lesson 3}
\label{sec:org96b66fe}
\section{Review Exercises}
\label{sec:org1c605d5}
...
\end{tabular}
\end{center}\footnotetext[4]{\label{orgbf57b85}\href{https://suttacentral.net/an4.67/pli/ms}{AN 4.67}}\footnotetext[5]{\label{orgdf87cd7}Paritta Ratanattaya-paṇāma, simpl.}\footnotetext[6]{\label{orgd30d7d4}\href{https://suttacentral.net/snp2.1/pli/ms}{Snp 2.1} simpl.}
...
\section{Exercises}
\label{sec:org8736dbb}
\subsection{Translate}
\label{sec:orgd0ec9f0}
...
\end{tabular}
\end{center}\footnotetext[8]{\label{orgf416928}Pc 65}\footnotetext[9]{\label{org4c4e8c8}\href{https://suttacentral.net/sn42.3/pli/ms}{SN 42.3}}\footnotetext[10]{\label{org2bf0c43}Pr 4, Pc 8}
...
\end{tabular}
\end{center}\footnotetext[11]{\label{org96ceebc}Dukkhappattā\ldots{} chant}
...
\chapter{Lesson 4}
\label{sec:org87b1b13}
\section{Review Exercises}
\label{sec:org0d110d4}
...
\section{Exercises}
\label{sec:orgef109ce}
\subsection{Translate}
\label{sec:org8eb614e}
...
\end{tabular}
\end{center}\footnotetext[13]{\label{org0fb6c04}AN 6.102}
...
\chapter{Lesson 5}
\label{sec:orgec98a62}
\section{Review Exercises}
\label{sec:org3dc0902}
...
\section{Exercises}
\label{sec:org4c24321}
\subsection{Translate}
\label{sec:org60d2403}
...
\end{tabular}
\end{center}\footnotetext[14]{\label{orgf4cd16c}MN 64, AN 9.36}
...
\chapter{Appendix}
\label{sec:orgc3d0330}
\section{Simple Present}
\label{sec:org186e688}
...
\label{sec:org4717d14}
\section{Aorist Past Tense}
\label{sec:orga650d42}
...
\label{sec:orge922dbc}
\subsection{Present Tense}
\label{sec:orge52c553}
...
\label{sec:org60fb18d}
\subsection{Present Tense}
\label{sec:orgff96dd0}
...
\label{sec:org36abdff}
\subsection{root + ta}
\label{sec:orgda2f0c6}
