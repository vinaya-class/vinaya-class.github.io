...
\chapter{Lesson 1}
\label{sec:orgd293faf}
\section{Language Notes}
\label{sec:org74fef4e}
...
\end{tabular}
\end{center}\footnotetext[1]{\label{org4d6f472}Yathā vāri-vahā pūrā\ldots{}}
...
\end{tabular}
\end{center}\footnotetext[2]{\label{org6a27e8f}\href{https://suttacentral.net/mn118/pli/ms}{MN 118}}
...
\chapter{Lesson 2}
\label{sec:org240f2d3}
\section{Review Exercises}
\label{sec:orga2d6f74}
...
\end{tabular}
\end{center}\footnotetext[3]{\label{org6974bc7}The only occurrence of vatth\textbf{ebhi}, normally it's vatth\textbf{ehi}.}
...
\end{tabular}
\end{center}\footnotetext[4]{\label{org8f5b8e5}\href{https://suttacentral.net/pli-tv-kd6/en/brahmali}{Mv. Kd 6}}
...
\end{tabular}
\end{center}\footnotetext[5]{\label{org8707a35}\href{https://suttacentral.net/an4.67/pli/ms}{AN 4.67}}\footnotetext[6]{\label{org310c767}Paritta Ratanattaya-paṇāma, simpl.}\footnotetext[7]{\label{orga9c9b63}\href{https://suttacentral.net/snp2.1/pli/ms}{Snp 2.1} simpl.}
...
\section{Exercises}
\label{sec:org2ebc7ed}
\subsection{Translate}
\label{sec:org68b5d9a}
...
\end{tabular}
\end{center}\footnotetext[9]{\label{orgd17bd73}Pc 65}\footnotetext[10]{\label{orge46e9a1}\href{https://suttacentral.net/sn42.3/pli/ms}{SN 42.3}}\footnotetext[11]{\label{orgf20758c}Pr 4, Pc 8}
...
\end{tabular}
\end{center}\footnotetext[12]{\label{org008670a}Dukkhappattā\ldots{} chant}
...
\chapter{Lesson 4}
\label{sec:org58dc612}
\section{Review Exercises}
\label{sec:org018c618}
...
\section{Exercises}
\label{sec:org6d062c3}
\subsection{Translate}
\label{sec:orgbaaa689}
...
\end{tabular}
\end{center}\footnotetext[14]{\label{orgffd72e5}AN 6.102}
...
\chapter{Lesson 5}
\label{sec:orgd856911}
\section{Review Exercises}
\label{sec:org2516b7e}
...
\section{Exercises}
\label{sec:org282a80f}
\subsection{Translate}
\label{sec:org925ba03}
...
\end{tabular}
\end{center}\footnotetext[15]{\label{orga529743}MN 64, AN 9.36}
...
\label{sec:orgbc3e65a}
\section{Aorist Past Tense}
\label{sec:orga623186}
...
\label{sec:org4a417f2}
\subsection{Present Tense}
\label{sec:org5e3a4b1}
...
\label{sec:org8a1eb9a}
\subsection{Present Tense}
\label{sec:orgc207550}
...
\label{sec:org13075d1}
\subsection{root + ta}
\label{sec:orgbf9effb}
