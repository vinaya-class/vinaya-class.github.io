...
\item[Pc 78 \orig] Eavesdropping in an argument% p.482
...
{\centering
\subsectionFmt{Closing}

%\hspace*{22pt}
\numberbullet{1} Summary\quad
\numberbullet{2} Review and final questions\quad
\numberbullet{3} Presentations\quad
\numberbullet{4} Close
